...
def adjacency_list(edges):
    ...
    # If there is any check isolated_vertex the problem is not solvable. This function returns True if there is any isolated vertex
